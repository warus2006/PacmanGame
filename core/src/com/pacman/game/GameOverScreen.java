...
public class GameOverScreen implements Screen {
    ...
    public void setPacMan(PacMan pacMan) {
        ...
        this.statisticBuilder.append("Score: ").append(pacMan.getScore()).append("\n")
                .append("Food eated: ").append(pacMan.getFoodEated()).append("\n");
    }
...
//        music.play();
    ...
    public void render(float delta) {
        ...
        font32.draw(batch, statisticBuilder, 0, 480, 1280, 1, false);
        font32.draw(batch, highScoreBuilder, 680, 480, 640, 1, false);
        batch.end();
        stage.draw();
    }
    ...
    public void createGUI() {
        ...
        field.setWidth(400);
        field.setPosition(640 - 400 / 2 - 200, 300);
        ...
        btnSaveResults.setPosition(640 + 420 / 2 + 40 - 200, 280);
